...
import 'package:share/pages/post_screen.dart';
...
class ActivityFeedItem extends StatelessWidget {
  ...
  configureMediaPreview(context) {
    ...
    if (type == "like") {
      activityItemText = "like yout post";
    } else if (type == "follow") {
      activityItemText = "is following you";
    } else if (type == "comment") {
      activityItemText = "replided: $commentData";
    } else {
