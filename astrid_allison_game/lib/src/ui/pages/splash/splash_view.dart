...
import 'package:astrid_allison_game/src/data/repositories_impl/images_repository_impl.dart';
import 'package:astrid_allison_game/src/ui/pages/game/game_view.dart';
import 'package:astrid_allison_game/src/ui/pages/splash/circle_transition_clipper.dart';
                              ...
                              children: [
                                Center(
                                  child: Image.asset("assets/images/foto.png",
                                      width: double.infinity, height: 380.0),
                                ),
                                Center(
                                  child: Text(
                                    "Juego de\nAstrid y Allison",
