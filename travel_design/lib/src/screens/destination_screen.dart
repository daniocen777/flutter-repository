...
import 'package:travel_design/src/models/activity_model.dart';
import 'package:travel_design/src/models/destination_model.dart';
...
class _DestinationScreenState extends State<DestinationScreen> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(activity.type,
                              style: TextStyle(color: Colors.grey)),
                          _buildTRatingStars(activity.rating),
  ...
  Widget _buildTRatingStars(int rating) {
    String stars = '';
